...
import TableWeapons from '../components/TableWeapons';
...
const Weapons = (props) => {
  ...
  const [selectedCategory, setSelectedCategory] = useState('ap'); // Valor inicial
          ...
          <div className='gnb--home css-nxrucq'>
            ...
            <div className='css-13j09rg'>
              ...
              <ul className='css-151lzeb'>
                ...
                <li className="navigation-item css-ap5w9a">
                  <a data-key="lnb_menu_tab" data-value="agents" target="_self" href="/agents"><span className="navigation-item__title">Agents</span>
                  </a></li>
              </ul>
            </div>
            <div className='css-a2zqi5'>
              <div className='header'>
                <div className="title-wrapper">
                  <h1>Weapons</h1>
                  <div className="desc">Find the highest Weapons on Valorant .
                  </div>
                </div>
              </div>
                ...
                <main className='css-q1xd7m'>
                  <div className="css-689mq1">
                    <div className="filter">
                      <section className="dropdown css-152yhh1 dropdown--focused">
                        <select style={{color: "#111"}} value={selectedCategory} onChange={handleCategoryChange}>
                          <option value="ar">Assault Riffle</option>
                          <option value="pistol">Pistol</option>
                          <option value="sniper">Sniper</option>
                        </select>
                        <label className="dropdown__label dropdown__label--medium dropdown__label--icon css-mtnbe1">
                          <span className="dropdown__label-content css-sm6uaa">Select Option</span>
                  ...
                  <div className='css-kpb0s1'>
                    <div className='css-1337qr9'>
                      <TableWeapons searchTerm={searchTerm} category={selectedCategory} />
                    </div>
                  </div>
                </main>
              </div>
