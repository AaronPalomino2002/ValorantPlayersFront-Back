            ...
            <div className='css-13j09rg'>
              ...
              <ul className='css-151lzeb'>
                ...
                <li className="navigation-item  navigation-item--selected css-ap5w9a">
                  <Link to='/agents' data-key="lnb_menu_tab" data-value="agents" target="_self" href="/agents"><span className="navigation-item__title">Agents</span>
                  </Link>
                </li>
              </ul>
            </div>
            <div className='css-a2zqi5'>
              <div className='header'>
                <div className="title-wrapper">
                  <h1>Agents</h1>
                  <div className="desc">Find the Valorant Agents from around the world.
                  </div>
                </div>
              </div>
                ...
                <main className='css-q1xd7m'>
                  ...
                  <div className='css-kpb0s1'>
                    <div className='css-1337qr9'>
                      <TableAgents searchTerm={searchTerm} category={selectedCategory} />
                    </div>
                  </div>
                </main>
              </div>
